namespace DogShelter.Web.Areas.Identity.Pages.Account
{
    using System;
    ...
    public class RegisterModel : PageModel
    {
        ...
        {
            [Required]
            [StringLength(18, ErrorMessage = "Username must be at least 6 and at max 18 characters long.", MinimumLength = 6)]
